...
!function () {
    ...
    !function (t, e) {
        ...
        warning: {label: "Warning", icon: "fas fa-exclamation-triangle", className: "warning"},
        ...
        var p = function t(e, o, r) {
            ...
            for (var l in o) try {
                o[l].constructor === Object && a < 1 ? e[l] = t(e[l], o[l], a + 1) : e[l] = o[l]
            } catch (t) {
                e[l] = o[l]
            }
            return e
        ...
        t.afterEach(function (t, e) {
            e(t.replace(/<\s*blockquote[^>]*>(?:<p>|[\S\n]*)?\[!(\w*)((?:\|[\w*:[\s\w\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF-]*)*?)\]([\s\S]*?)(?:<\/p>)?<\s*\/\s*blockquote>/g, function (t, e, o, r) {
                ...
                if (!a) return t;
                var l = m(o, "style", p.style), n = m(o, "iconVisibility", "visible", function (t) {
                    return "hidden" !== t
                }), c = m(o, "labelVisibility", "visible", function (t) {
                    return "hidden" !== t
                }), i = m(o, "label", a.label), d = m(o, "icon", a.icon), s = m(o, "className", a.className);
                if ("object" === g(i)) {
