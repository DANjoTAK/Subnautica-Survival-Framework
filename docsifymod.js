!function () {
    ...
    }), l = Object.prototype.hasOwnProperty, h = Object.assign || function (e) {
    ...
    var u = document, v = u.body, d = u.head;
    ...
    function S(e) {
        ...
        if (n) for (var r in t) if (l.call(t, r)) {
    ...
    var L = Object.hasOwnProperty, C = Object.setPrototypeOf, R = Object.isFrozen, ke = Object.keys, xe = Object.freeze,
        F = Object.seal, O = "undefined" != typeof Reflect && Reflect, $ = O.apply, M = O.construct;
    $ = $ || function (e, t, n) {
        return e.apply(t, n)
    }, xe = xe || function (e) {
        return e
    ...
    var we = N(Array.prototype.forEach), _e = N(Array.prototype.indexOf), Ae = N(Array.prototype.join),
        Se = N(Array.prototype.pop), Te = N(Array.prototype.push), Ee = N(Array.prototype.slice),
        Le = N(String.prototype.toLowerCase), Ce = N(String.prototype.match), Re = N(String.prototype.replace),
        Fe = N(String.prototype.indexOf), Oe = N(String.prototype.trim), $e = N(RegExp.prototype.test), Me = z(RegExp),
        Ne = z(TypeError);
    ...
    var je = xe(["a", "abbr", "acronym", "address", "area", "article", "aside", "audio", "b", "bdi", "bdo", "big", "blink", "blockquote", "body", "br", "button", "canvas", "caption", "center", "cite", "code", "col", "colgroup", "content", "data", "datalist", "dd", "decorator", "del", "details", "dfn", "dir", "div", "dl", "dt", "element", "em", "fieldset", "figcaption", "figure", "font", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "head", "header", "hgroup", "hr", "html", "i", "img", "input", "ins", "kbd", "label", "legend", "li", "main", "map", "mark", "marquee", "menu", "menuitem", "meter", "nav", "nobr", "ol", "optgroup", "option", "output", "p", "picture", "pre", "progress", "q", "rp", "rt", "ruby", "s", "samp", "section", "select", "shadow", "small", "source", "spacer", "span", "strike", "strong", "style", "sub", "summary", "sup", "table", "tbody", "td", "template", "textarea", "tfoot", "th", "thead", "time", "tr", "track", "tt", "u", "ul", "var", "video", "wbr"]),
        ...
        Ge = F(/\{\{[\s\S]*|[\s\S]*\}\}/gm), Ye = F(/<%[\s\S]*|[\s\S]*%>/gm), Ve = F(/^data-[\-\w.\u00B7-\uFFFF]/),
        Xe = F(/^aria-[\-\w]+$/),
        Ke = F(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),
        Qe = F(/^(?:\w+script|data):/i), Je = F(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205f\u3000]/g),
    ...
    var P, j, D = function t(e) {
        ...
        var u = c.document, o = !1, s = !1, l = c.document, p = c.DocumentFragment, n = c.HTMLTemplateElement,
            h = c.Node, r = c.NodeFilter, i = c.NamedNodeMap,
            a = void 0 === i ? c.NamedNodeMap || c.MozNamedAttrMap : i, f = c.Text, g = c.Comment, m = c.DOMParser,
            v = c.trustedTypes;
        if ("function" == typeof n) {
            var y = l.createElement("template");
            y.content && y.content.ownerDocument && (l = y.content.ownerDocument)
        }
        var b = rt(v, u), k = b ? b.createHTML("") : "", x = l, w = x.implementation, _ = x.createNodeIterator,
            A = x.getElementsByTagName, S = x.createDocumentFragment, T = u.importNode, E = {};
        ...
        var O = Ge, $ = Ye, M = Ve, N = Xe, z = Qe, P = Je, j = Ke, D = null,
            H = ze({}, [].concat(tt(je), tt(De), tt(He), tt(qe), tt(Ie))), q = null,
            I = ze({}, [].concat(tt(Ue), tt(Be), tt(Ze), tt(We))), U = null, B = null, Z = !0, W = !0, G = !1, Y = !1,
            V = !1, X = !1, K = !1, Q = !1, J = !1, ee = !1, te = !1, ne = !1, re = !0, ie = !0, ae = !1, oe = {},
        ...
        function me(e) {
            ...
            if (D[n] && !U[n]) return "noscript" === n && $e(/<\/noscript/i, e.innerHTML) ? (C(e), !0) : "noembed" === n && $e(/<\/noembed/i, e.innerHTML) ? (C(e), !0) : (!Y || e.firstElementChild || e.content && e.content.firstElementChild || !$e(/</g, e.textContent) || (Te(d.removed, {element: e.cloneNode()}), e.innerHTML ? e.innerHTML = Re(e.innerHTML, /</g, "&lt;") : e.innerHTML = Re(e.textContent, /</g, "&lt;")), V && 3 === e.nodeType && (t = e.textContent, t = Re(t, O, " "), t = Re(t, $, " "), e.textContent !== t && (Te(d.removed, {element: e.cloneNode()}), e.textContent = t)), ge("afterSanitizeElements", e, null), !1);
        ...
        function ve(e, t, n) {
            ...
            if (W && $e(M, t)) ; else if (Z && $e(N, t)) ; else {
                if (!q[t] || B[t]) return !1;
                if (ce[t]) ; else if ($e(j, Re(n, P, ""))) ; else if ("src" !== t && "xlink:href" !== t && "href" !== t || "script" === e || 0 !== Fe(n, "data:") || !le[e]) if (G && !$e(z, Re(n, P, ""))) ; else if (n) return !1
            }
            return !0
        }

        function ye(e) {
            var t = void 0, n = void 0, r = void 0, i = void 0, a = void 0;
            ge("beforeSanitizeAttributes", e, null);
            var o = e.attributes;
            if (o) {
                var s = {attrName: "", attrValue: "", keepAttr: !0, allowedAttributes: q};
                for (a = o.length; a--;) {
                    var l = t = o[a], c = l.name, u = l.namespaceURI;
                    if (n = Oe(t.value), r = Le(c), s.attrName = r, s.attrValue = n, s.keepAttr = !0, s.forceKeepAttr = void 0, ge("uponSanitizeAttribute", e, s), n = s.attrValue, !s.forceKeepAttr) {
                        if ("name" === r && "IMG" === e.nodeName && o.id) i = o.id, o = Ee(o, []), R("id", e), R(c, e), _e(o, i) > a && e.setAttribute("id", i.value); else {
                            if ("INPUT" === e.nodeName && "type" === r && "file" === n && s.keepAttr && (q[r] || !B[r])) continue;
                            "id" === c && e.setAttribute(c, ""), R(c, e)
                        }
                        if (s.keepAttr) if (Y && $e(/\/>/i, n)) R(c, e); else if ($e(/svg|math/i, e.namespaceURI) && $e(Me("</(" + Ae(ke(se), "|") + ")", "i"), n)) R(c, e); else {
                            V && (n = Re(n, O, " "), n = Re(n, $, " "));
        ...
        return d.sanitize = function (e, t) {
            var n = void 0, r = void 0, i = void 0, a = void 0, o = void 0;
            ...
            if (K || L(t), d.removed = [], "string" == typeof e && (ae = !1), ae) ; else if (e instanceof h) 1 === (r = (n = F("\x3c!--\x3e")).ownerDocument.importNode(e, !0)).nodeType && "BODY" === r.nodeName ? n = r : "HTML" === r.nodeName ? n = r : n.appendChild(r); else {
            ...
            if (J) {
                if (ee) for (o = S.call(n.ownerDocument); n.firstChild;) o.appendChild(n.firstChild); else o = n;
    ...
    function I(a, e, t) {
        ...
        var o = new XMLHttpRequest, r = q[a];
        if (r) return {
            then: function (e) {
            ...
            then: function (r, i) {
                ...
                n("error", i), n("load", function (e) {
                    ...
                    if (400 <= t.status) i(t); else {
                        var n = q[a] = {content: t.response, opt: {updatedAt: o.getResponseHeader("last-modified")}};
                        r(n.content, n.opt)
                    }
                })
            }, abort: function (e) {
    ...
    function B(e, t, r, i) {
        void 0 === i && (i = p);
        var a = e._hooks[t], o = function (t) {
            var e = a[t];
            if (t >= a.length) i(r); else if ("function" == typeof e) if (2 === e.length) e(r, function (e) {
                r = e, o(t + 1)
            }); else {
                var n = e(r);
    ...
    function G(e, t, r, n) {
        ...
        return i.sort(function (e, t) {
            ...
            var t = e.getAttribute("href"), n = r ? e.parentNode : e;
            0 !== o.indexOf(t) || a ? _(n, "remove", "active") : (a = e, _(n, "add", "active"))
        }), n && (u.title = a ? a.title || a.innerText + " - " + Z : Z), a
    }

    var Y = decodeURIComponent, V = encodeURIComponent;
        ...
        if (fe) {
            ...
            if (t) {
                ...
                if (p && p !== a && (a && a.classList.remove("active"), p.classList.add("active"), a = p, !de && v.classList.contains("sticky"))) {
                    var d = n.clientHeight, h = a.offsetTop + a.clientHeight + 40, f = h - 0 < d,
    ...
    function ye(e, t) {
        if (t) {
            ...
            var i = pe[ve(e, t)], a = y(m(".sidebar"), "li.active");
    ...
    var ot = at(function (v, e) {
        !function () {
            ...
            b._label = /(?!\s*\])(?:\\[\[\]]|[^\[\]])+/, b._title = /(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/, b.def = e(b.def).replace("label", b._label).replace("title", b._title).getRegex(), b.bullet = /(?:[*+-]|\d{1,9}\.)/, b.item = /^( *)(bull) ?[^\n]*(?:\n(?!\1bull ?)[^\n]*)*/, b.item = e(b.item, "gm").replace(/bull/g, b.bullet).getRegex(), b.list = e(b.list).replace(/bull/g, b.bullet).replace("hr", "\\n+(?=\\1?(?:(?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$))").replace("def", "\\n+(?=" + b.def.source + ")").getRegex(), b._tag = "address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|section|source|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul", b._comment = /<!--(?!-?>)[\s\S]*?-->/, b.html = e(b.html, "i").replace("comment", b._comment).replace("tag", b._tag).replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(), b.paragraph = e(b._paragraph).replace("hr", b.hr).replace("heading", " {0,3}#{1,6} +").replace("|lheading", "").replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}|~{3,})[^`\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|!--)").replace("tag", b._tag).getRegex(), b.blockquote = e(b.blockquote).replace("paragraph", b.paragraph).getRegex(), b.normal = h({}, b), b.gfm = h({}, b.normal, {
                ...
                for (e = e.replace(/^ +$/gm, ""); e;) if ((i = this.rules.newline.exec(e)) && (e = e.substring(i[0].length), 1 < i[0].length && this.tokens.push({type: "space"})), i = this.rules.code.exec(e)) {
            ...
            n._punctuation = "!\"#$%&'()*+,\\-./:;<=>?@\\[^_{|}~", n.em = e(n.em).replace(/punctuation/g, n._punctuation).getRegex(), n._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g, n._scheme = /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/, n._email = /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/, n.autolink = e(n.autolink).replace("scheme", n._scheme).replace("email", n._email).getRegex(), n._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/, n.tag = e(n.tag).replace("comment", b._comment).replace("attribute", n._attribute).getRegex(), n._label = /(?:\[[^\[\]]*\]|\\.|`[^`]*`|[^\[\]\\`])*?/, n._href = /<(?:\\[<>]?|[^\s<>\\])*>|[^\s\x00-\x1f]*/, n._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/, n.link = e(n.link).replace("label", n._label).replace("href", n._href).replace("title", n._title).getRegex(), n.reflink = e(n.reflink).replace("label", n._label).getRegex(), n.normal = h({}, n), n.pedantic = h({}, n.normal, {
                ...
                for (var t, n, r, i, a, o, s = ""; e;) if (a = this.rules.escape.exec(e)) e = e.substring(a[0].length), s += k(a[1]); else if (a = this.rules.tag.exec(e)) !this.inLink && /^<a /i.test(a[0]) ? this.inLink = !0 : this.inLink && /^<\/a>/i.test(a[0]) && (this.inLink = !1), !this.inRawBlock && /^<(pre|code|kbd|script)(\s|>)/i.test(a[0]) ? this.inRawBlock = !0 : this.inRawBlock && /^<\/(pre|code|kbd|script)(\s|>)/i.test(a[0]) && (this.inRawBlock = !1), e = e.substring(a[0].length), s += this.options.sanitize ? this.options.sanitizer ? this.options.sanitizer(a[0]) : k(a[0]) : a[0]; else if (a = this.rules.link.exec(e)) {
                    var l = f(a[2], "()");
                    if (-1 < l) {
                    ...
                    if (a = this.rules.text.exec(e)) e = e.substring(a[0].length), this.inRawBlock ? s += this.renderer.text(this.options.sanitize ? this.options.sanitizer ? this.options.sanitizer(a[0]) : k(a[0]) : a[0]) : s += this.renderer.text(k(this.smartypants(a[0]))); else if (e) throw new Error("Infinite loop on byte: " + e.charCodeAt(0))
                } else {
                    if ("@" === a[2]) r = "mailto:" + (n = k(a[0])); else {
                ...
                var n = t.href, r = t.title ? k(t.title) : null;
                ...
                this.inline = new u(e.links, this.options), this.inlineText = new u(e.links, h({}, this.options, {renderer: new i})), this.tokens = e.reverse();
                ...
                switch (this.token.type) {
                    ...
                    case"list_item_start":
                        a = "";
                        var l = this.token.loose, c = this.token.checked, u = this.token.task;
                        for (this.token.task && (a += this.renderer.checkbox(c)); "list_item_end" !== this.next().type;) a += l || "text" !== this.token.type ? this.tok() : this.parseText();
    ...
    var mt, vt = at(function (e) {
            ...
            var u = /\blang(?:uage)?-([\w-]+)\b/i, t = 0, F = {
                ...
                languages: {
                    extend: function (e, t) {
                        ...
                        var i = (r = r || F.languages)[n], a = {};
                        for (var o in i) if (i.hasOwnProperty(o)) {
                            if (o == e) for (var s in t) t.hasOwnProperty(s) && (a[s] = t[s]);
                ...
                highlightElement: function (e, t, n) {
                    var r = F.util.getLanguage(e), i = F.languages[r];
                    ...
                    if (F.hooks.run("before-highlight", o), o.grammar) if (t && c.Worker) {
                        var l = new Worker(F.filename);
                        l.onmessage = function (e) {
                            s(e.data)
                        }, l.postMessage(JSON.stringify({language: o.language, code: o.code, immediateClose: !0}))
                    } else s(F.highlight(o.code, o.grammar, o.language)); else s(F.util.encode(o.code))
                },
                ...
                matchGrammar: function (e, t, n, r, i, a, o) {
                    for (var s in n) if (n.hasOwnProperty(s) && n[s]) {
                        ...
                        for (var c = 0; c < l.length; ++c) {
                            if (o && o == s + "," + c) return;
                            var u = l[c], p = u.inside, d = !!u.lookbehind, h = !!u.greedy, f = 0, g = u.alias;
                            ...
                            for (var v = r, y = i; v < t.length; y += t[v].length, ++v) {
                                ...
                                if (!(b instanceof O)) {
                                    ...
                                    if (S) {
                                        ...
                                        var E = b.slice(0, k), L = b.slice(x), C = [v, T];
        ...
        e.exports && (e.exports = c), void 0 !== it && (it.Prism = c), c.languages.markup = {
            ...
            value: function (e, t) {
                ...
                r["language-" + t] = {pattern: /[\s\S]+/, inside: c.languages[t]};
                var i = {};
                i[e] = {
        ...
        }), c.languages.xml = c.languages.extend("markup", {}), c.languages.html = c.languages.markup, c.languages.mathml = c.languages.markup, c.languages.svg = c.languages.markup, function (e) {
            var t = /("|')(?:\\(?:\r\n|[\s\S])|(?!\1)[^\\\r\n])*\1/;
            e.languages.css = {
                comment: /\/\*[\s\S]*?\*\//,
                    ...
                    !function e(t) {
                        for (var n = 0; n < t.length && !(g >= m.length); n++) {
                            ...
                            if ("string" == typeof r || r.content && "string" == typeof r.content) {
                                var i = m[g], a = h.tokenStack[i], o = "string" == typeof r ? r : r.content,
                                    s = yt(f, i), l = o.indexOf(s);
                                if (-1 < l) {
                                    ++g;
                                    var c = o.substring(0, l),
                                        u = new mt.Token(f, mt.tokenize(a, h.grammar), "language-" + f, a),
                                        p = o.substring(l + s.length), d = [];
    ...
    var bt = {}, kt = {
        ...
        var n = i.markdown || {};
        o = r(n) ? n(ot, t) : (ot.setOptions(h(n, {renderer: h(t, n.renderer)})), ot), this._marked = o, this.compile = function (n) {
    ...
    xt.prototype.compileEmbed = function (e, t) {
        var n, r = gt(t), i = r.str, a = r.config;
        if (t = i, a.include) {
            var o;
            if (Q(e) || (e = re(this.contentBase, ee(this.router.getCurrentPath()), e)), a.type && (o = kt[a.type])) (n = o.call(this, e, t)).type = a.type; else {
                var s = "code";
        ...
        var e = new ot.Renderer, t = this.linkTarget, n = this.linkRel, l = this.router, r = this.contentBase, c = this,
            i = {};
        return i.heading = e.heading = function (e, t) {
            var n = gt(e), r = n.str, i = n.config, a = {level: t, title: r};
            ...
            var o = ht(i.id || r), s = l.toURL(l.getCurrentPath(), {id: o});
        ...
        }({renderer: e}), i.link = function (e) {
            var t = e.renderer, s = e.router, l = e.linkTarget, c = e.linkRel, u = e.compilerClass;
            return t.link = function (e, t, n) {
                void 0 === t && (t = "");
                var r = [], i = gt(t), a = i.str, o = i.config;
        ...
        }({renderer: e, router: l, linkTarget: t, linkRel: n, compilerClass: c}), i.paragraph = function (e) {
            return e.renderer.paragraph = function (e) {
                return /^!&gt;/.test(e) ? lt("tip", e) : /^\?&gt;/.test(e) ? lt("warn", e) : "<p>" + e + "</p>"
            }
        }({renderer: e}), i.image = function (e) {
            var t = e.renderer, p = e.contentBase, d = e.router;
            return t.image = function (e, t, n) {
                var r = e, i = [], a = gt(t), o = a.str, s = a.config;
                if (t = o, s["no-zoom"] && i.push("data-no-zoom"), t && i.push('title="' + t + '"'), s.size) {
                    var l = s.size.split("x"), c = l[0], u = l[1];
        ...
        }({renderer: e, contentBase: r, router: l}), i.list = function (e) {
    ...
    function At(e, i) {
        var o = e.compiler, a = e.raw;
        void 0 === a && (a = "");
        var t = e.fetch, n = _t[a];
        if (n) {
            var r = n.slice();
            return r.links = n.links, i(r)
        }
        var s = o._marked, l = s.lexer(a), c = [], u = s.InlineLexer.rules.link, p = l.links;
        ...
        var d = [];
        !function (e, o) {
            var t, n = e.embedTokens, s = e.compile, l = (e.fetch, 0), c = 1;
            ...
            for (; t = n[l++];) {
                var r = function (a) {
                    return function (e) {
                        ...
                        }]).links = {} : (t = [{type: "html", text: e}]).links = {};
            ...
            var t = e.embedToken, n = e.token;
            if (n) {
                var r = n.index;
                d.forEach(function (e) {
                    r > e.start && (r += e.length)
                }), h(p, t.links), l = l.slice(0, r).concat(t, l.slice(r + 1)), d.push({start: r, length: t.length - 1})
    ...
    function Lt(e) {
        ...
        var n = t.el || "#app", r = y("nav") || g("nav"), i = y(n), a = "", o = v;
        if (i) {
            if (t.repo && (a += function (e, t) {
                ...
                var s = /^data:image/.test(t.logo), l = /(?:http[s]?:)?\/\//.test(t.logo), c = /^\./.test(t.logo);
    ...
    Rt.prototype.getBasePath = function () {
        ...
        var n = this.config, r = this.getBasePath(), i = "string" == typeof n.ext ? n.ext : ".md";
        ...
        void 0 === e && (e = p), e()
    }, Rt.prototype.getCurrentPath = function () {
    }, Rt.prototype.normalize = function () {
    }, Rt.prototype.parse = function () {
    }, Rt.prototype.toURL = function (e, t, n) {
        var r = n && "#" === e[0], i = this.parse(ie(e));
    ...
    var Ot = function (r) {
        ...
        return r && (e.__proto__ = r), ((e.prototype = Object.create(r && r.prototype)).constructor = e).prototype.getBasePath = function () {
            ...
            0 <= n && (e = e.slice(n + 1));
            var r = e.indexOf("?");
            return 0 <= r && (t = e.slice(r + 1), e = e.slice(0, r)), {path: e, file: this.getFile(e, !0), query: X(t)}
        ...
        return t && (e.__proto__ = t), ((e.prototype = Object.create(t && t.prototype)).constructor = e).prototype.getCurrentPath = function () {
            ...
            void 0 === r && (r = p), x("click", function (e) {
                ...
                if ("A" === t.tagName && !/_blank/.test(t.target)) {
                    e.preventDefault();
                    var n = t.href;
                    -1 !== i.config.crossOriginLinks.indexOf(n) ? window.open(n, "_self") : window.history.pushState({key: n}, "", n), r({
                        event: e,
                        source: "navigate"
                    })
                }
            ...
            var r = re(location.origin), i = e.indexOf(r);
            return -1 < i && (e = e.slice(i + r.length)), {path: e, file: this.getFile(e), query: X(t)}
        }, e
    }(Rt);
    var Mt = {};
    ...
    Ut._init = function () {
        ...
        if (function (e) {
            ...
            for (var i = 0, a = r.length; i < a; i += 1) {
                var o = r[i], s = o.querySelector("a");
                if (s) {
                    var l = s.getAttribute("href");
                    if ("/" !== l) {
                        var c = e.parse(l), u = c.query.id, p = c.path;
                        u && (l = ve(p, u))
                    }
        ...
        B(this, "beforeEach", r, function (e) {
            ...
            var n;
            o.isHTML ? (n = o.result = r, t(), a()) : At({compiler: o.compiler, raw: e}, function (e) {
        ...
        !function (e) {
            var t = m(".app-name-link"), n = e.config.nameLink, r = e.route.path;
            if (t) if (c(e.config.nameLink)) t.setAttribute("href", n); else if ("object" == typeof n) {
                var i = Object.keys(n).filter(function (e) {
        ...
        var r = this;
        void 0 === n && (n = p);
        var e = this.route, i = e.path, a = K(e.query, ["id"]), t = this.config, o = t.loadNavbar, s = t.requestHeaders,
            l = t.loadSidebar, c = this.router.getFile(i), u = Bt(c + a, 0, s);
        ...
        var r = this;
        void 0 === n && (n = p);
        var i = this.config, a = i.loadSidebar, o = i.requestHeaders, s = i.notFoundPage,
